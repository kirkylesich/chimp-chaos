...
async fn create_report(
    ...
    let chaos_report = domain::models::ChaosReport {
        experiment_ref: domain::models::ExperimentRef {
            namespace: ns.clone(),
            name: name.clone(),
        },
        windows: domain::models::Windows {
            baseline: "b".into(),
            failure: "f".into(),
        },
        results: Vec::new(),
        topology: domain::models::Topology {
            nodes: Vec::new(),
            edges: Vec::new(),
        },
...
async fn run_experiment(
    ...
    let mut exp_status = domain::models::ChaosExperimentStatus {
        phase: Phase::Pending,
        started_at: None,
        ends_at: None,
        baseline_window: None,
